...
1. Test Lenis smooth scroll on the user's Mac trackpad at `https://премиум-продюсер.рф/`; tune `lerp` and `wheelMultiplier` in `src/assets/js/features/smooth-scroll.js` if it feels too heavy, too slippery, or too delayed.
